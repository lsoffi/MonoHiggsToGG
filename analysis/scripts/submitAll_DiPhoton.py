...
#./submitBatchDiPho.py --cfg diPhoAnaBATCH.py DoubleEG_ReReco         		0 10003 pippo 1 1
#./submitBatchDiPho.py --cfg diPhoAnaBATCH.py DoubleEG_Prompt         		0 10004 pippo 1 1
...
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP600			1 100 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00009338  1 #46.69fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP800			1 101 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00010348  1 #51.74fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP1000		1 102 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00008394  1 #41.97fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP1200		1 103 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00006352  1 #31.76fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP1400		1 104 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00004712  1 #23.56fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP1700		1 105 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00003020  1 #15.10fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP2000		1 106 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.000019468 1 #9.734fb xsec * 0.002br
./submitBatchDiPho.py --cfg diPhoAnaBATCH.py privMC_2HDM_MZP2500		1 107 /afs/cern.ch/user/c/crovelli/public/json2015/doubleEG/pileupWeights___processedAndGolden_finalAfewMissing__69mb.root 1.0 1 #0.00000972  1 #4.860fb xsec * 0.002br
